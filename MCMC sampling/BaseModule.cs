...
namespace Preprocessing_MCMC_sampling
{
    public partial class BaseModule : Form
    {
        ...
        String controlDataFile = @"C:\Users\Azad\OneDrive - UNSW\own files\Fund application\Salem\Project-1\Part 1\Identifying key players in aberrant pathways\Data\nR_GE_data_GSE38376.csv";
        String caseDataFile = @"C:\Users\Azad\OneDrive - UNSW\own files\Fund application\Salem\Project-1\Part 1\Identifying key players in aberrant pathways\Data\R_GE_data_GSE38376.csv";
        String pathwaysFile = @"C:\Users\Azad\OneDrive - UNSW\own files\Fund application\Salem\Project-1\Part 1\Identifying key players in aberrant pathways\Data\KEGG_45_SIGNALING.csv";
        ...
        {
            TextWriter twDat = new StreamWriter("GSE38376_standardizedOnly.csv");
