...
namespace Preprocessing_MCMC_sampling
{
    ...
    class bugsSampling
    {
        ...
        {
            SharpJags.Jags.JagsConfig.BinPath = @"C:\Program Files\JAGS\JAGS-4.3.1\x64\bin";
            ...
            Vector<double> x = Enumerable.Range(0, n).ToList().ConvertAll(i => (double)i).ToArray();
            ...
            // -- Run MCMC sampling 
            var samples = JagsWrapper.Run(run, pars);
            ...
            Directory.CreateDirectory("JAGS_output");
