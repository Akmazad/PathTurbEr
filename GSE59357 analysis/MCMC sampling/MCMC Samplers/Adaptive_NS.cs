...
namespace Preprocessing_MCMC_sampling
{
    class Adaptive_NS
    {
        ...
        public Adaptive_NS(NameValueCollection inputSettings, List<string> methodSettings, List<string> outputSettings, Dictionary<String, int[]> pathwayDataMat)
        {
            ...
            twFx = new StreamWriter(@"BNMCMC_output\\LogFx_NS_" + pathway +".csv");
        ...
        //public void StartAnalysis(ref BackgroundWorker backgroundWorker1)
        public List<string> StartAnalysis()
        {
            ...
            string cpu_cycle = ((int)Stopwatch.GetTimestamp()).ToString();
            int seed = int.Parse(cpu_cycle.Substring(cpu_cycle.Length - 3, 2));
            ...
            for (; iter < nMaxIteration; iter++)
            {
                ...
                //txtProgress.Text = "Iteration completed: " + iter.ToString();
                ...
                while (Z_count > 0)
                {
                    ...
                    if (ratioZ >= Ux)
                    {
                        if (ch_AcceptRatio.Equals("MH"))
                        {
                            ...
                            twFx.WriteLine(_global_LogFx.ToString() + "," + iter.ToString());
        ...
        private List<string> Find_Network_with_Highest_Frequency()
        {
            ...
            for (int i = 0; i < this.th_num_Ordinal_OutputNetwork; i++)
